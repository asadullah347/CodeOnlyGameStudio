...
BOOL InitInstance(HINSTANCE hInstance, int nCmdShow)
{
   ...
   HWND hWnd = CreateWindowW(szWindowClass, L"뱀 머리 2탄", WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        x[1] = 20 + BSIZE * 2 * 2 ; y[1] = 20;
        x[0] = 20 + BSIZE * 2 * 1 ; y[0] = 20;
        x[2] = 20 + BSIZE * 2 * 0 ; y[2] = 20;
    ...
    case WM_PAINT:
        {
            ...
            //격자 네무 그리기
            Rectangle(hdc, 0, 0, (int)(rectView.right/40) * 40,
                (int)(rectView.bottom/40)*40);
            //뱀 머리
            ...
            Ellipse(hdc, x[2] - 20, y[2] - 20, x[2] + 20, y[2] + 20);
            EndPaint(hWnd, &ps);
        }
        break;
    case WM_DESTROY:
